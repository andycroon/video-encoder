...
**Current focus:** Phase 10 — file-browser-with-directory-browsing-file-rename-move-and-copy
...
- Phase 10 added: File browser with directory browsing, file rename, move and copy
