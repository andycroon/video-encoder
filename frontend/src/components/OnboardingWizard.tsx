...
export default function OnboardingWizard() {
  ...
  const disabled = loading || !username || !password || !confirmPassword;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: 16 }}>
          <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--txt)' }}>Set up your account</div>
          <div style={{ fontSize: 14, color: 'var(--txt-3)', marginTop: 4 }}>
            Create credentials to protect remote access to this instance.
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="onboarding-username" style={labelStyle}>Username</label>
            <input
          ...
          {/* Password */}
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="onboarding-password" style={labelStyle}>Password</label>
            <input
          ...
          {/* Confirm Password */}
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="onboarding-confirm" style={labelStyle}>Confirm Password</label>
            <input
